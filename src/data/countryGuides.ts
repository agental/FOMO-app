  ...
  sections: [
    {
      ...
      items: [
        { id: 'grab', name: 'Grab', emoji: '🚕', tag: 'חובה', subtitle: 'מוניות, טוקטוק ומשלוחי אוכל',
        ...
        { id: 'bolt', name: 'Bolt', emoji: '🚗', tag: 'זול', subtitle: 'אלטרנטיבה זולה לגראב',
        ...
        { id: 'gmaps', name: 'Google Maps', emoji: '🗺️', subtitle: 'הורידו מפות אופליין',
        ...
        { id: 'translate', name: 'Google Translate', emoji: '🌐', subtitle: 'תרגום תאית + מצלמה',
          description: 'הורידו את חבילת השפה התאית לאופליין. מצב המצלמה מתרגם תפריטים ושלטים בזמן אמת — מציל חיים בדוכני אוכל.' },
        { id: 'klook', name: 'Klook', emoji: '🎟️', tag: 'חוסך כסף', subtitle: 'אטרקציות וכרטיסים בזול',
        ...
        { id: 'agoda', name: 'Agoda', emoji: '🏨', subtitle: 'הכי חזק להזמנת לינה באסיה',
        ...
        { id: '12go', name: '12Go', emoji: '🚌', subtitle: 'אוטובוסים, רכבות ומעבורות בין ערים',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'truemove', name: 'TrueMove H', emoji: '📶', subtitle: 'מצוין בערים',
          description: 'כיסוי חזק בבנגקוק ובערים. דלפקים בכל שדות התעופה, מתקינים לכם במקום.' },
        { id: 'dtac', name: 'dtac', emoji: '📱', tag: 'זול', subtitle: 'הכי משתלם',
          description: 'לרוב הזול מבין השלושה, כיסוי טוב במרכז ובאזורים התיירותיים.' },
        { id: 'airalo', name: 'Airalo eSIM', emoji: '🌍', tag: 'ליום הראשון', subtitle: 'eSIM בלי להחליף כרטיס',
  ...
  sections: [
    {
      id: 'apps', title: 'אפליקציות שימושיות', emoji: '📱', color: C.apps,
      items: [
        { id: 'grab', name: 'Grab', emoji: '🚕', tag: 'חובה', subtitle: 'רכב, אופנוע ואוכל',
        ...
        { id: 'gmaps', name: 'Google Maps', emoji: '🗺️', subtitle: 'מפות אופליין',
          description: 'הורידו את מפות האזור לאופליין — קליטה לא תמיד יציבה מחוץ לערים.' },
        { id: 'translate', name: 'Google Translate', emoji: '🌐', subtitle: 'וייטנאמית + מצלמה',
          description: 'האנגלית מוגבלת מחוץ לאזורי תיירות. תרגום מצלמה לתפריטים הוא חובה.' },
        { id: '12go', name: '12Go', emoji: '🚌', subtitle: 'אוטובוסים ורכבות',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'airalo', name: 'Airalo eSIM', emoji: '🌍', tag: 'ליום הראשון', subtitle: 'eSIM מהבית',
